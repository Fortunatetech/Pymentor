    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-50 px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-dark-900 mb-2">Start learning Python!</h1>
          <p className="text-dark-500">Create your free account to get started</p>
        </div>

        <div className="card p-8">
          <button
            onClick={handleGoogleSignup}
            className="btn-secondary btn-md w-full mb-6"
          >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-4 text-dark-400">or sign up with email</span>
            </div>
          </div>
