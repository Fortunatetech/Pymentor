    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-dark-900">Start learning Python</h1>
          <p className="text-dark-500 mt-2">Create your free account</p>
        </div>

        <div className="bg-white rounded-2xl p-8 shadow-sm border border-dark-100">
          <button
            onClick={handleGoogleSignup}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-dark-200 rounded-xl hover:bg-dark-50 transition-colors mb-6"
          >
